...
{
    [CustomEditor(typeof(FlexibleReuseScrollView))]
    public sealed class FlexibleReuseScrollViewEditor : UnityEditor.Editor
    {
        #region Context Menu
        ...
        [MenuItem("GameObject/UI/Flexible Reuse Scroll View", false)]
        private static void CreateReusableScrollView(MenuCommand menuCommand)
        {
            ...
            scrollviewObject.name = "FlexibleReuseScrollView";
            ...
            var scrollView = scrollviewObject.AddComponent<FlexibleReuseScrollView>();
        ...
        private FlexibleReuseScrollView _target;
        private bool _prevVertical, _prevHorizontal;

        private void OnEnable()
        {
            _target = target as FlexibleReuseScrollView;
        }
